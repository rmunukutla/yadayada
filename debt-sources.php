<?php
  ...
  */
  ...
  //Credit card
  if (isset($_POST['Credit-Card-Nickname-3'])
      && isset($_POST['credit-card-balance-2'])
      && isset($_POST['credit-card-min-payment-2'])
      && isset($_POST['credit-card-apr-2'])) {

        //Move form values into variables
        $user_id = 1; // This needs to be tied to user login TBD
        $credit_card_nickname= $_POST['Credit-Card-Nickname-3'];
        $credit_card_balance = $_POST['credit-card-balance-2'];
        $credit_card_min_payment = $_POST['credit-card-min-payment-2'];
        $credit_card_apr = $_POST['credit-card-apr-2'];
      ...
      //Student loan
      if(isset($_POST['Student-Loan-Nickname-2']) &&
         isset($_POST['Original-Student-Loan-Amount-2']) &&
         isset($_POST['Student-Loan-Interest-Rate-2']) &&
         isset($_POST['Student-Loan-Remain-Term-2'])) {

           //Move form values into variables
           $user_id = 1; // This needs to be tied to user login TBD
           $student_loan_nickname = $_POST['Student-Loan-Nickname-2'];
           $original_student_loan_amount = $_POST['Original-Student-Loan-Amount-2'];
           $student_loan_interest_rate = $_POST['Student-Loan-Interest-Rate-2'];
           $student_loan_remain_term = $_POST['Student-Loan-Remain-Term-2'];
         ...
         //Payday loan
         if(isset($_POST['Payday-Loan-Nickname-2']) &&
            isset($_POST['Original-Payday-Loan-Amount-2']) &&
            isset($_POST['Payday-Loan-Interest-Rate-2']) &&
            isset($_POST['Payday-Loan-Remain-Term-2'])) {

              //Move form values into variables
              $user_id = 1; // This needs to be tied to user login TBD
              $payday_loan_nickname = $_POST['Payday-Loan-Nickname-2'];
              $original_payday_loan_amount = $_POST['Original-Payday-Loan-Amount-2'];
              $payday_loan_interest_rate = $_POST['Payday-Loan-Interest-Rate-2'];
              $payday_loan_remain_term = $_POST['Payday-Loan-Remain-Term-2'];
            ...
            //Loan
            if(isset($_POST['Loan-Nickname-2']) &&
               isset($_POST['Original-Loan-Amount-2']) &&
               isset($_POST['Loan-Interest-Rate-2']) &&
               isset($_POST['Loan-Remain-Term-2'])) {

                 //Move form values into variables
                 $user_id = 1; // This needs to be tied to user login TBD
                 $loan_nickname = $_POST['Loan-Nickname-2'];
                 $original_loan_amount = $_POST['Original-Loan-Amount-2'];
                 $loan_interest_rate = $_POST['Loan-Interest-Rate-2'];
                 $loan_remain_term = $_POST['Loan-Remain-Term-2'];
               ...
               //Legal Obligation
               if(isset($_POST['Legal-Obligation-Nickname-2']) &&
                  isset($_POST['Legal-Obligation-Amount-2']) &&
                  isset($_POST['Legal-Obligation-Interest-Rate-2']) &&
                  isset($_POST['Legal-Obligation-Remaining-Term-2'])) {

                    //Move form values into variables
                    $user_id = 1; // This needs to be tied to user login TBD
                    $legal_obligation_nickname = $_POST['Legal-Obligation-Nickname-2'];
                    $legal_obligation_loan_amount = $_POST['Legal-Obligation-Amount-2'];
                    $legal_obligation_interest_rate = $_POST['Legal-Obligation-Interest-Rate-2'];
                    $legal_obligation_remain_term = $_POST['Legal-Obligation-Remaining-Term-2'];
      ...
      <div>
        ...
        <div id="debt-credit-card-input-box" data-w-id="2868bbbb-a940-b8ab-10e9-8bd8e9acd264" style="display:none" class="div-block box">
          <div id="credit-card-form" class="w-form">
            ...
            <form autocomplete="off" id="wf-form-Credit-Card-Form" name="wf-form-Credit-Card-Form" data-name="Credit Card Form">
              <label for="Credit-Card-Nickname-3" class="form-label">Nickname</label>
              <input type="text" class="w-input" maxlength="256" name="Credit-Card-Nickname-3" data-name="Credit Card Nickname 3" placeholder="e.g. My Visa Fun Card" id="Credit-Card-Nickname-3" required="">
              <div class="data-descriptor">
                <div>At this point, what is your...</div>
              </div><label for="credit-card-balance-3" class="form-label">Balance</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="credit-card-balance-2" data-name="Credit Card Balance 2" placeholder="e.g. $5,143.47" id="credit-card-balance-2" required="">
              <label for="credit-card-min-payment-3" class="form-label">Minimum Payment</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="credit-card-min-payment-2" data-name="Credit Card Min Payment 2" placeholder="e.g. $35.43" id="credit-card-min-payment-2" required="">
              <label for="credit-card-apr-3" class="form-label">APR</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="credit-card-apr-2" data-name="Credit Card Apr 2" placeholder="e.g. 29.99%" id="credit-card-apr-2" required="">
        ...
        <div id="debt-student-loan-input-box" class="div-block box" style="display:none">
          <div id="student-loan-form" class="w-form">
            ...
            <form autocomplete="off" id="wf-form-Student-Loan-Form" name="wf-form-Student-Loan-Form" data-name="Student Loan Form">
              <label for="Student-Loan-Nickname-2" class="form-label">Nickname</label>
              <input type="text" class="w-input" maxlength="256" name="Student-Loan-Nickname-2" data-name="Student Loan Nickname 2" placeholder="e.g. For My Great Education" id="Student-Loan-Nickname-2" required="">
              <div class="data-descriptor">
                <div>At this point, what was your...</div>
              </div><label for="Original-Student-Loan-Amount-2" class="form-label">Original Loan Amount</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Original-Student-Loan-Amount-2" data-name="Original Student Loan Amount 2" placeholder="e.g. $86,000.00" id="Original-Student-Loan-Amount-2" required="">
              <label for="Student-Loan-Interest-Rate-2" class="form-label">Interest Rate</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Student-Loan-Interest-Rate-2" data-name="Student Loan Interest Rate 2" placeholder="e.g.  4.45%" id="Student-Loan-Interest-Rate-2" required="">
              <label for="Student-Loan-Remain-Term-2" class="form-label">Remaining Term</label>
              <select id="Student-Loan-Remain-Term-2" name="Student-Loan-Remain-Term-2" data-name="Student Loan Remain Term 2" class="w-select" required="">
        ...
        <div id="debt-payday-loan-input-box" class="div-block box" style="display:none">
          <div id="payday-loan-form" class="w-form">
            ...
            <form autocomplete="off" id="wf-form-Payday-Loan-Form" name="wf-form-Payday-Loan-Form" data-name="Payday Loan Form">
              <label for="Payday-Loan-Nickname-2" class="form-label">Nickname</label>
              <input type="text" class="w-input" maxlength="256" name="Payday-Loan-Nickname-2" data-name="Payday Loan Nickname 2" placeholder="e.g. A Quick Fix" id="Payday-Loan-Nickname-2" required="">
              <div class="data-descriptor">
                <div>So tell me, what was your...</div>
              </div><label for="Original-Payday-Loan-Amount-2" class="form-label">Original Loan Amount</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Original-Payday-Loan-Amount-2" data-name="Original Payday Loan Amount 2" placeholder="e.g. $1,000.00" id="Original-Payday-Loan-Amount-2" required="">
              <label for="Payday-Loan-Interest-Rate-2" class="form-label">Interest Rate</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Payday-Loan-Interest-Rate-2" data-name="Payday Loan Interest Rate 2" placeholder="e.g.  400%" id="Payday-Loan-Interest-Rate-2" required="">
              <label for="Payday-Loan-Remain-Term-2" class="form-label">Original Loan Date</label>
              <input type="date" id="Payday-Loan-Remain-Term-2" name="Payday-Loan-Remain-Term-2" data-name="Payday Loan Remain Term 2" class="w-select" required="">
        ...
        <div id="debt-loan-input-box" class="div-block box" style="display:none">
          <div id="loan-form" class="w-form">
            ...
            <form autocomplete="off" id="wf-form-Loan-Form" name="wf-form-Loan-Form" data-name="Loan Form">
              <label for="Loan-Nickname-2" class="form-label">Nickname</label>
              <input type="text" class="w-input" maxlength="256" name="Loan-Nickname-2" data-name="Loan Nickname 2" placeholder="e.g. For My Car" id="Loan-Nickname-2" required="">
              <div class="data-descriptor">
                <div>So tell me, what was your...</div>
              </div><label for="Original-Loan-Amount-2" class="form-label">Original Loan Amount</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Original-Loan-Amount-2" data-name="Original Loan Amount 2" placeholder="e.g. $30,000.00" id="Original-Loan-Amount-2" required="">
              <label for="Loan-Interest-Rate-2" class="form-label">Interest Rate</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Loan-Interest-Rate-2" data-name="Loan Interest Rate 2" placeholder="e.g.  29.99%" id="Loan-Interest-Rate-2" required="">
              <label for="Loan-Remain-Term-2" class="form-label">Remaining Term</label><select id="Loan-Remain-Term-2" name="Loan-Remain-Term-2" data-name="Loan Remain Term 2" class="w-select" required="">
        ...
        <div id="debt-legal-obligation-input-box" class="div-block box" style="display:none">
          <div id="loan-form" class="w-form">
            ...
            <form autocomplete="off" id="wf-form-Loan-Form" name="wf-form-Loan-Form" data-name="Loan Form">
              <label for="Legal-Obligation-Nickname-2" class="form-label">Nickname</label>
              <input type="text" class="w-input" maxlength="256" name="Legal-Obligation-Nickname-2" data-name="Legal Obligation Nickname 2" placeholder="e.g. Child Support" id="Legal-Obligation-Nickname-2" required="">
              <div class="data-descriptor">
                <div>So tell me, what is your...</div>
              </div><label for="Legal-Obligation-Amount-2" class="form-label">Original Loan Amount</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Legal-Obligation-Amount-2" data-name="Legal Obligation Amount 2" placeholder="e.g. $30,000.00" id="Legal-Obligation-Amount-2" required="">
              <label for="Legal-Obligation-Interest-Rate-2" class="form-label">Interest Rate</label>
              <input type="number" step="0.01" class="w-input" maxlength="256" name="Legal-Obligation-Interest-Rate-2" data-name="Legal Obligation Interest Rate 2" placeholder="e.g.  29.99%" id="Legal-Obligation-Interest-Rate-2" required="">
              <label for="Legal-Obligation-Remaining-Term-2" class="form-label">Remaining Term</label>
              <select id="Legal-Obligation-Remaining-Term-2" name="Legal-Obligation-Remaining-Term-2" data-name="Legal Obligation Remaining Term 2" class="w-select" required="">
